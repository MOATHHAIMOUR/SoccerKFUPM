...
using Namespace.SoccerKFUPM.Application.Common.Behaviours;
using Namespace.SoccerKFUPM.Application.Services.PlayerServices;
using SoccerKFUPM.Application.Services;
...
namespace SoccerKFUPM.Infrastructure.Repository
{
    public static class DependencyInjection
    {
            ...
            IConfiguration configuration)
        {
            ...
            services.AddScoped<ICoachServices, CoachServices>();
